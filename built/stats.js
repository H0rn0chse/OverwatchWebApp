 ...
 */
function maxInList(list, property, min) {
 ...
 */
function firstGreaterThan(list, property, min) {
    return list.reduce((acc, val) => {
        if (acc > min) {
            return acc;
        }
 ...
 * @param min the minimum threshold
 */
function lastGreaterThan(list, property, min) {
    return list.reduce((acc, val) => {
        if (val[property] > min) {
            return val[property];
        }
 ...
 */
function evaluateIfConditions(item, ifConditions) {
 ...
 */
function filterIf(list, ifConditions) {
    return list.reduce((acc, val) => {
 ...
 * For more details @see evaluateIfConditions.
 */
function countIf(list, ifConditions) {
    return list.reduce((acc, val) => {
        if (evaluateIfConditions(val, ifConditions)) {
            acc += 1;
        }
 ...
 * For more details @see evaluateIfConditions.
 */
function sumIf(list, sumProperty, ifConditions) {
    const result = {
        sum: 0,
        count: 0
    };
 ...
 * For more details @see evaluateIfConditions.
 */
function sumIfAverage(list, sumProperty, ifConditions) {
 ...
 */
function largestGroup(list, property, value) {
    return list.reduce((acc, val) => {
...
export function getEnhancedEntries() {
    const entries = ROLES
        .reduce((acc, role) => {
